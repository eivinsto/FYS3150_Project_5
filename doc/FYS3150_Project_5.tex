...
\begin{align*}
Q(x,y,t) = \begin{cases}
\,\,\, 1.4 \text{ $\mu$W/m$^3$} \quad , \quad  y<20 \\
0.35 \text{ $\mu$W/m$^3$} \quad , \quad 20<y<40 \\
0.05 \text{ $\mu$W/m$^3$} \quad , \quad y>40
\end{cases}
\end{align*}
